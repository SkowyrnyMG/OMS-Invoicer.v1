...
describe('Name of the group', () => {
  ...
  test('should update invoice template with order details after using finised order setter combobox ', async () => {
    ...
    // await userEvent.type(finishedOrderSetter, '22222222');
    await fireEvent.change(finishedOrderSetter, { target: { value: 'TEST' } });
    // await screen.findByText('TESTORD - 555 EUR - TEST COMPANY NAME');
